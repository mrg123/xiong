          ...
          <table class="table">
            <tbody>
              <tr>
                ...
                <td><a href="<?php echo HTTPS_CATALOG; ?>" target="_blank"><?php echo $store_name; ?></a></td>
              </tr>
              <tr>
...
// Login to the API
$.ajax({
	url: '<?php echo HTTPS_CATALOG; ?>index.php?route=api/login',
	type: 'post',
	dataType: 'json',
...
$('#button-history').on('click', function() {
	...
	$.ajax({
		url: '<?php echo HTTPS_CATALOG; ?>index.php?route=api/order/history&token=' + token + '&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
