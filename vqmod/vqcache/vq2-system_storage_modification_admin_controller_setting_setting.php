...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_odnoklassniki'] = $this->language->get('entry_odnoklassniki');
		$data['entry_html'] = $this->language->get('entry_html');
		$data['entry_card'] = $this->language->get('entry_card');
		$data['entry_card2'] = $this->language->get('entry_card2');
		...
		if (isset($this->request->post['config_card'])) {
			$data['config_card'] = $this->request->post['config_card'];
		} else {
			$data['config_card'] = $this->config->get('config_card');
		}

		if (isset($this->request->post['config_html'])) {
			$data['config_html'] = $this->request->post['config_html'];
		} else {
