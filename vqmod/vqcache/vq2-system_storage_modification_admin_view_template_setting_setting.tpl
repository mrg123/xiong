          ...
          <label class="col-sm-2 control-label" for="config_smartsupp_enabled">Enable Smartsupp chat</label>
			...
			<div class="tab-pane" id="tab-footer">
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-odnoklassniki"><?php echo $entry_odnoklassniki; ?></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_odnoklassniki" value="<?php echo $config_odnoklassniki; ?>" placeholder="<?php echo $entry_odnoklassniki; ?>" id="input-odnoklassniki" class="form-control" />
                  </div>
                </div>
				
                <div class="form-group">
                  <label class="col-sm-4 control-label" for="input-card"><?php echo $entry_card; ?><br /><br /><?php echo $entry_card2; ?></label>
                  <div class="col-sm-8">
                    <textarea name="config_card" rows="10" placeholder="<?php echo $entry_card; ?>" id="input-card" class="form-control"><?php echo $config_card; ?></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea name="config_html" rows="10" placeholder="<?php echo $entry_html; ?>" id="input-html" class="form-control"><?php echo $config_html; ?></textarea>
                  </div>
                </div>
              </fieldset>
            </div>
