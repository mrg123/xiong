...
<script type="text/javascript"><!--
 ...
 document.getElementById("welcome").innerHTML = '<a href="#loginpopuphead_form" title="" class="loginpopuphead"><img alt="" src="<?php echo $thickboxbutton; ?>"/></a>';
...
$('.loginpopuphead').fancybox({  'padding' : 0,  'scrolling'        : 'no',   'titleShow'        : false,   });
