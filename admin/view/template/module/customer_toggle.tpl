      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customer-toggle" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-customer_toggle_status"><?php echo $entry_status; ?></label>
            <div class="col-sm-10">
              <select name="customer_toggle_status" id="input-customer_toggle_status" class="form-control">
                <?php if ($customer_toggle_status) { ?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right toggle">
                    <?php if($customer['toggle']){ ?>
					<label>
					<input type="radio" name="toggle_<?php echo $customer['customer_id']; ?>" id="toggle_<?php echo $customer['customer_id']; ?>" value="1" checked="checked" data-customer-id = "<?php echo $customer['customer_id']; ?>"/>
					<?php echo $text_enabled; ?>
					</label>
					<label>
					<input type="radio" name="toggle_<?php echo $customer['customer_id']; ?>" id="toggle_<?php echo $customer['customer_id']; ?>" value="0" data-customer-id = "<?php echo $customer['customer_id']; ?>"/>
					<?php echo $text_disabled; ?>
					</label>
					<?php }else{ ?>
					<label>
					<input type="radio" name="toggle_<?php echo $customer['customer_id']; ?>" id="toggle_<?php echo $customer['customer_id']; ?>" value="1" data-customer-id = "<?php echo $customer['customer_id']; ?>"/>
					<?php echo $text_enabled; ?>
					</label>
					<label>
					<input type="radio" name="toggle_<?php echo $customer['customer_id']; ?>" id="toggle_<?php echo $customer['customer_id']; ?>" value="0" checked="checked" data-customer-id = "<?php echo $customer['customer_id']; ?>"/>
					<?php echo $text_disabled; ?>
					</label>
					<?php } ?>
				  </td>
...
$('.toggle input').on('click', function() {
	//alert($(this).val());
	$.ajax({
		url: 'index.php?route=module/customer_toggle/updateToggle&token=<?php echo $token; ?>&toggle=' + this.value + '&customer_id=' + $(this).data('customer-id'),
		dataType:'json',
